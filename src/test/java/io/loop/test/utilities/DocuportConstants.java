...
public class DocuportConstants {
    ...
    public static final String ERROR_MASSEGE_FOR_EMPTY_PASSWORD =  "Please enter your password";
    ...
    public static final String EXPECTED_URL_FORGOT_PASSWORD = "https://beta.docuport.app/reset-password";
