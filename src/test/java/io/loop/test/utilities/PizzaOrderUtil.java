...
public class PizzaOrderUtil {
     ...
     * @param name
     * @param field
     * @return the field value for a given name
     * @author NSH
     */

    public static String returnFieldValue(WebDriver driver, String name, String field) throws InterruptedException {
       ...
       if(field.equalsIgnoreCase("Pizza Type")){
           ...
           System.out.println("There is not such field" + field);
       }
